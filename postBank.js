const data = [
    ...
    { id: 2, name: "Hermione Jean Granger", aka: "Queen Slug", house: "Gryffindor", blood: "Muggle-born", wand: `10¾", vine wood, dragon heartstring core`, patronus: "Otter", pic: `https://static.wikia.nocookie.net/harrypotter/images/3/34/Hermione_Granger.jpg/revision/latest?cb=20210522145306` },
    { id: 3, name: "Tom Riddle", aka: "Lord Voldemort", house: "Slytherin", blood: "Half-blood", wand: `13½", Yew, phoenix feather core`, patronus: "none", pic: `https://static.wikia.nocookie.net/harrypotter/images/a/aa/Voldemort_Headshot_DHP1.png/revision/latest/scale-to-width-down/350?cb=20161203031453` },
    ...
    { id: 6, name: "Professor Albus Dumbledor", aka: "Professor", house: "Gryffindor", blood: "Half-blood", wand: `15", Elder, Thestral tail hair core`, patronus: "Phoenix", pic: `https://static.wikia.nocookie.net/harrypotter/images/4/40/Albus_Dumbledore_%28HBP_promo%29_3.jpg/revision/latest/scale-to-width-down/350?cb=20150822232849` },
